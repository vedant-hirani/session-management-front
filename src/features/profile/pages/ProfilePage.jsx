        ...
        <div className="profile-card">
          {!isEditing ? (
            <div className="profile-view">
              ...
              <div className="profile-info-item"><span className="label">First Name</span><span className="value">{user.first_name || 'Not set'}</span></div>
              <div className="profile-info-item"><span className="label">Last Name</span><span className="value">{user.last_name || 'Not set'}</span></div>
              <div className="profile-info-item"><span className="label">Bio</span><span className="value">{user.bio || 'Not set'}</span></div>
              <div className="profile-info-item"><span className="label">Account Type</span><span className="value">{getRoleDisplay(user.role)}</span></div>
